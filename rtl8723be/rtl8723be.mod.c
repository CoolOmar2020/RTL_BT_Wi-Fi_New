...
__attribute__((section("__versions"))) = {
	...
	{ 0xc5f39793, "efuse_one_byte_read" },
	{ 0x349af104, "rtl_tx_report_handler" },
	{ 0x37a0cba, "kfree" },
	{ 0x69acdf38, "memcpy" },
	...
	{ 0xd1f9ad3a, "rtl8723be_firmware_selfreset" },
	{ 0xa2b02079, "rtl_c2hcmd_enqueue" },
